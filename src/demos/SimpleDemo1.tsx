...
export default [
        ...
        value: {
            ...
            fields: [
                ...
                },
                {
                    ...
                    label: () => (
                        <div>
                            Description with <NTag>custom content</NTag>
                        </div>
                    ),
                    type: "textarea",
                    required: true,
                    description: {
                        ...
                        content: () => (
                            <div>
                                This is a <b style={{ color: "red" }}>description</b> with a HTML content rendered
                                <TestComp />
                            </div>
                        ),
                    },
            ...
            fields: [
                {
                    ...
                    options: async () =>
                        await fetchGet("https://dog.ceo/api/breeds/list/all")
                            .then((response) => Object.keys(response.message).map((item) => ({ label: item, value: item })))
                            .catch((_) => []),
                },
                {
                    key: "dogSubBreed",
                    ...
                    options: async ({ dogBreed }) =>
                        !dogBreed
                            ? []
                            : await fetchGet(`https://dog.ceo/api/breed/${dogBreed}/list`)
                                  .then((response) => response.message.map((item) => ({ label: item, value: item })))
                                  .catch((err) => []),
                },
                {
            ...
            fields: [
                {
                    ...
                    fields: [
                        { type: "text", key: "key", label: "Module key", required: true },
                        {
                            ...
                            label: "Module type",
                            required: true,
                            options: ["Composite", "External", "Async"].map((item) => ({ label: item, value: item.toLowerCase() })),
                        },
        ...
        value: {
            ...
            fields: [
                { type: "slider", key: "maxItemsInArray", label: "Max items in array", required: true, fieldParams: { gap: 1, min: 1, max: 10 }, size: "8" },
                {
                    ...
                    label: "Array",
                    key: "array",
                    fields: [{ type: "text", key: "innerField", label: "Inner field", required: true }],
                    required: true,
                    dependencies: ["maxItemsInArray"],
                    validators: (dependencies: any) => ({
                        maxItemsInArray: helpers.withMessage(
                            "The array can not have more than " + dependencies.maxItemsInArray + " items",
                            maxLength(dependencies.maxItemsInArray),
                        ),
                    }),
                },
            ],
        ...
        value: {
            ...
            fields: [
                { type: "slider", key: "maxItemsInArray", label: "Max items in array", required: true, fieldParams: { gap: 1, min: 1, max: 10 }, size: "8" },
                {
                    ...
                    validators: (dependencies: any) => ({
                        maxItemsInArray: helpers.withMessage(
                            "The array can not have more than " + (dependencies?.maxItemsInArray ?? 0) + " items",
                            maxLength(dependencies?.maxItemsInArray ?? 0),
                        ),
                    }),
                },
            ],
    ...
    },
    {
        ...
        value: {
            ...
            fields: [
                ...
                {
                    key: "short_label",
                    label: "Exam short label",
                    type: "text",
                    required: true,
                    validators: { maxLength: helpers.withMessage("The short label must not exceed 35 characters", maxLength(35)) },
                },
                {
                    key: "pages",
                    label: "START PAGES",
    ...
    },
    {
        ...
        value: {
            ...
            gridSize: "8",
            fieldSize: "8",
            fields: [{ key: "test", type: "array", label: "test", extraProperties: true, fields: [{ key: "firstName", label: "First name", type: "text" }] }],
        },
    },
    {
        label: "Sync test",
        ...
        value: {
            ...
            fields: [
                ...
                },
                {
                    ...
                    headerTemplate: ({ label }: { label: string }, index: number) => `ITEM ${index + 1}: ${label || ""}`,
                    // preformat: (items: AffiliationGroup["items"]) => items.map((item) => ({ ...item, __uuid: generateUUID() })),
                },
            ],
        },
        inputData: {
            _id: "6319ff801477478947a86a54",
            items: [
                {
                    label: "zqdqzddzqzqd gi",
                    _id: "6319ff801477478947a86a55",
                    updatedAt: "2022-09-08T15:16:03.208Z",
                    createdAt: "2022-09-08T15:16:03.208Z",
                },
                {
                    label: "zqdzdqqzdqzdzqdqzd d22015",
                    _id: "6319ff801477478947a86a56",
                    updatedAt: "2022-09-08T15:16:03.208Z",
                    createdAt: "2022-09-08T15:16:03.208Z",
                },
            ],
            name: "test xxx",
            createdAt: "2022-09-08T14:43:12.139Z",
            updatedAt: "2022-09-08T15:16:03.208Z",
            __v: 0,
        },
    },
    {
        label: "Dependencies in array",
        value: {
            title: "Create new affiliation group" ,
            fieldSize: 8,
            fullScreen: false,
            fields: [
                {
                ...
                },
                {
                    ...
                    headerTemplate: ({ label }: { label: string }, index: number) => `ITEM ${index + 1}: ${label || ""}`,
                    dependencies: ["items"],
                    // validators: (dependencies: { items: Array<{ label: string }>}) => {
                    //     const items = dependencies.items;
                    //     console.log({ items })
                    //     return {
                    //         minLen: helpers.withMessage("You must have at least 3 item", () => items.length > 3)
                    //     }
                    // }
                },
            ],
